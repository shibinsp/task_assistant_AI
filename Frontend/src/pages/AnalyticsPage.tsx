...
export default function AnalyticsPage() {
  ...
  // Override stats cards with real data when available
  const dynamicStatsCards = metrics ? [
    {
      title: 'Tasks Completed',
  ...
  const apiVelocityData = velocityRaw?.weeks?.map((w) => ({
    week: w.week,
    planned: w.planned,
            ...
            <CardContent>
              <div className="h-[280px]">
                <ResponsiveContainer width="100%" height="100%">
                  <AreaChart data={apiVelocityData ?? velocityData}>
                    <defs>
