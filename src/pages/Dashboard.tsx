...
// Recent tasks
const recentTasks = [
  { id: 1, title: 'Update API documentation', status: 'completed', priority: 'medium', assignee: 'JD' },
  { id: 2, title: 'Fix authentication bug', status: 'in-progress', priority: 'high', assignee: 'SM' },
  { id: 3, title: 'Design new landing page', status: 'pending', priority: 'low', assignee: 'AW' },
  { id: 4, title: 'Optimize database queries', status: 'in-progress', priority: 'high', assignee: 'RK' },
  { id: 5, title: 'Write unit tests', status: 'pending', priority: 'medium', assignee: 'ML' },
];
            ...
            <CardContent className="p-4 flex items-center gap-4">
              ...
              <div className="flex-1 min-w-0">
                ...
                <p className="text-sm text-muted-foreground truncate">
                  Your team completed 23% more tasks this week. Keep the momentum going!
                </p>
              </div>
